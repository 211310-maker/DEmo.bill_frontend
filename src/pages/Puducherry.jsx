...
const Puducherry = () => {
  ...
  if (!isLoggedIn.accessState.includes(fields.stateName.puducherry)) {
    return (
      <>
        <Header />
    ...
    <>
      ...
      <div className='text-center'>
        <p className='login-heading mt-4'>
          <b>BORDER TAX PAYMENT FOR ENTRY INTO</b> <span>PUDUCHERRY</span>
        </p>
      </div>
            ...
            <div className='col-6'>
              ...
              <div className='form__control'>
                ...
                >
                  ...
                  {fields.puducherry.vehiclePermitType.map((type) => {
                    return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.puducherry.borderBarrier.map((district) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.puducherry.checkPostName.map((checkpost) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.puducherry.serviceType.map((type) => {
                        return (
                          <option value={type.name} key={type.name}>
                            {type.name}
                          </option>
