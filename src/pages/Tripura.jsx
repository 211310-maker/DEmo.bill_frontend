...
const Tripura = () => {
  ...
  if (!isLoggedIn.accessState.includes(fields.stateName.tripura)) {
    return (
      <>
        <Header />
    ...
    <>
      ...
      <div className='text-center'>
        <p className='login-heading mt-4'>
          <b>BORDER TAX PAYMENT FOR ENTRY INTO</b> <span>TRIPURA</span>
        </p>
      </div>
            ...
            <div className='col-6'>
              ...
              <div className='form__control'>
                ...
                >
                  ...
                  {fields.tripura.vehiclePermitType.map((type) => {
                    return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.tripura.borderBarrier.map((district) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.tripura.checkPostName.map((checkpost) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.tripura.serviceType.map((type) => {
                        return (
                          <option value={type.name} key={type.name}>
                            {type.name}
                          </option>
