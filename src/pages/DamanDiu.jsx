...
const DamanDiu = () => {
  ...
  if (!isLoggedIn.accessState.includes(fields.stateName.damandiu)) {
    return (
      <>
        <Header />
    ...
    <>
      ...
      <div className='text-center'>
        <p className='login-heading mt-4'>
          <b>BORDER TAX PAYMENT FOR ENTRY INTO</b> <span>DAMAN & DIU</span>
        </p>
      </div>
            ...
            <div className='col-6'>
              ...
              <div className='form__control'>
                ...
                >
                  ...
                  {fields.damandiu.vehiclePermitType.map((type) => {
                    return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.damandiu.borderBarrier.map((district) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.damandiu.checkPostName.map((checkpost) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.damandiu.serviceType.map((type) => {
                        return (
                          <option value={type.name} key={type.name}>
                            {type.name}
                          </option>
