...
const Sikkim = () => {
  ...
  if (!isLoggedIn.accessState.includes(fields.stateName.sikkim)) {
    return (
      <>
        <Header />
    ...
    <>
      ...
      <div className='text-center'>
        <p className='login-heading mt-4'>
          <b>BORDER TAX PAYMENT FOR ENTRY INTO</b> <span>SIKKIM</span>
        </p>
      </div>
            ...
            <div className='col-6'>
              ...
              <div className='form__control'>
                ...
                >
                  ...
                  {fields.sikkim.vehiclePermitType.map((type) => {
                    return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.sikkim.borderBarrier.map((district) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.sikkim.checkPostName.map((checkpost) => {
                        return (
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.sikkim.serviceType.map((type) => {
                        return (
                          <option value={type.name} key={type.name}>
                            {type.name}
                          </option>
